...
const ImportSchema = z.object({
  ...
  settings: z.object({
    ...
    simulator: z.object({
      ...
      stackingBoxLengthMm: z.number().positive().optional(),
      stackingBoxWidthMm: z.number().positive().optional(),
      stackingClearanceMm: z.number().min(0).optional(),
        ...
        importGraph(
          ...
          ({
            ...
            simulator: parsed.settings.simulator ? {
              ...
              stackingBoxLengthMm: parsed.settings.simulator.stackingBoxLengthMm ?? 1200,
              stackingBoxWidthMm: parsed.settings.simulator.stackingBoxWidthMm ?? 800,
              stackingClearanceMm: parsed.settings.simulator.stackingClearanceMm ?? 200,
            } : {
              ...
              stackingColumns: 12,
              stackingLevels: 3,
              stackingBoxLengthMm: 1200,
              stackingBoxWidthMm: 800,
              stackingClearanceMm: 200,
